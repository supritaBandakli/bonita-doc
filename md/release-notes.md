...
### [Readable UI Designer artifact names](ui-designer-overview.md#readable-names) in Bonita repositories
...
* The supported Tomcat version for this new release is Tomcat 8.5.31 packaged in default Bonita Tomcat Bundle.
